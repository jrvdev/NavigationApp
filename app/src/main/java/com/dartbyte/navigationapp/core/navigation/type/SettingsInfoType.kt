package com.dartbyte.navigationapp.core.navigation.type
...
val settingsInfoType = object :NavType<SettingInfo>(isNullableAllowed = true){
    ...
    override fun get(bundle: Bundle, key: String): SettingInfo? {
    ...
    override fun put(bundle: Bundle, key: String, value: SettingInfo) {
